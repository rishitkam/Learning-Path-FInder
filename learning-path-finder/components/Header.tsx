...
import { clearSession, usePathData } from "@/lib/store";
...
export default function Header() {
  ...
  return <header className="topbar">
    ...
    <div className="topbar-right">
      <button className="new-button" onClick={() => { forgetSession(); clearSession(); }} disabled={!data} title="Clear this route and start again">
